...
export function NewJournalEntryModal({
  ...
  const handleLineChange = (
    ...
    const newLine = { accountId: '', debit: 0, credit: 0, ...newLines[index] };
    if (field === 'accountId') newLine.accountId = value;
    else if (field === 'debit') newLine.debit = value;
    else if (field === 'credit') newLine.credit = value;
