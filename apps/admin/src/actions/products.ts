 ...
 */
// biome-ignore lint/suspicious/noExplicitAny: Product data types can be diverse
 ...
 */
// biome-ignore lint/suspicious/noExplicitAny: Updates can be partial and dynamic
