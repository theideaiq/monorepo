...
describe('Cart Store', () => {
  ...
  const item1 = { id: 'apple-id', productId: 'apple-id', title: 'Apple', price: 100, image: 'apple.png' };
  const item2 = { id: 'banana-id', productId: 'banana-id', title: 'Banana', price: 200, image: 'banana.png' };
  ...
  it('should update quantity and recalculate total', () => {
    ...
    // Quantity < 1 should be ignored based on implementation
