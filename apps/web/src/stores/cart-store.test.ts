...
describe('Cart Store', () => {
  ...
  const item1 = { id: 'apple', productId: 'apple', title: 'Apple', price: 1, image: '' };
  const item2 = { id: 'banana', productId: 'banana', title: 'Banana', price: 2, image: '' };
  const item3 = { id: 'persistent-item', productId: 'persistent-item', title: 'Persistent', price: 3, image: '' };
