...
// biome-ignore lint/suspicious/noExplicitAny: rental structure from Supabase
        ...
        >
          <div className="flex items-center gap-4 mb-4">
            {rental.product?.image_url && (
              // biome-ignore lint/performance/noImgElement: using normal img for simplicity in account page
              <img
