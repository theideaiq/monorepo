...
const MENU_ITEMS = [
  {
    ...
    price: '6,000',
    description:
      'Lettuce, tomatoes, cheese, corn, black olives, beans, special dressing.',
    calories: '450 kcal', // Estimated
    image:
      'https://images.unsplash.com/photo-1599974579688-8dbdd3b43d36?q=80&w=2000', // Taco Salad lookalike
    tags: ['Spicy', 'Protein'],
  },
  {
    id: 2,
    ...
    price: '6,000',
    description:
      'Crisp lettuce, grilled chicken breast, parmesan cheese, crunchy croutons, Caesar dressing.',
    calories: '380 kcal',
    image:
      'https://images.unsplash.com/photo-1550304943-4f24f54ddde9?q=80&w=2000',
  ...
  },
  {
    ...
    price: '5,500',
    description:
      'Feta cheese, fresh cucumbers, tomatoes, lettuce, black olives, chickpeas, mushrooms.',
    calories: '320 kcal',
    image:
  ...
  },
  {
    ...
    price: '4,500',
    description:
      'Watercress (Jarjeer), fresh mint, parsley, parmesan, croutons, raisins, balsamic glaze.',
    calories: '280 kcal',
    image:
      'https://images.unsplash.com/photo-1512621776951-a57141f2eefd?q=80&w=2000',
    tags: ['Power', 'Light'],
  },
  {
    id: 5,
    ...
    price: '2,000',
    description:
      'A cup of fresh, seasonal cut fruits. The perfect natural sugar rush.',
    calories: '150 kcal',
    image:
      'https://images.unsplash.com/photo-1519996529931-28324d1a630e?q=80&w=2000', // Fruit cup
    tags: ['Vegan', 'Sweet'],
  },
];
...
export default function ZaytonaPage() {
  const handleOrder = (itemName: string) => {
    ...
    window.open(
      `https://wa.me/9647813100060?text=${encodeURIComponent(message)}`,
      '_blank',
    );
  };
        ...
        <div className="container relative z-10 flex flex-col items-center text-center px-4">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-stone-500 max-w-lg mx-auto font-medium">
              Real food for real innovators. <br /> Fresh, clean, and delivered
              to your desk.
            </p>
          </motion.div>
        </div>
              ...
              <div className="relative h-64 w-full rounded-[1.5rem] overflow-hidden mb-6">
                ...
                <div className="absolute top-4 left-4 flex gap-2">
                  {item.tags.map((tag) => (
                    <span
                      key={tag}
                      className="bg-white/90 backdrop-blur text-xs font-bold px-3 py-1 rounded-full text-stone-800 shadow-sm"
                    >
                      {tag}
                    </span>
                  ))}
              ...
              <div className="px-2 pb-2">
                <div className="flex justify-between items-start mb-2">
                  <div>
                    ...
                    <p className="text-sm font-arabic text-stone-400 font-bold">
                      {item.nameAr}
                    </p>
                  </div>
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="mt-16 pt-16 border-t border-white/10">
            <p className="text-stone-600 text-sm">
              Part of The IDEA Spaces Ecosystem.
            </p>
          </div>
        </div>
      </section>
