        ...
        <div className="max-w-7xl mx-auto relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-lg text-slate-300 mb-8 max-w-lg leading-relaxed">
              One platform to handle your procurement, recruitment, and employee
              training. Simplify your operations with The IDEA Suite.
            </p>
            <div className="flex flex-col sm:flex-row gap-4">
              <Button className="h-14 px-8 text-lg">Contact Sales</Button>
              <Button
                variant="outline"
                className="h-14 px-8 text-lg border-white text-white hover:bg-white hover:text-brand-dark"
              >
                Download Brochure
              </Button>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-500 mt-4">
              Everything you need to run a modern business in Baghdad.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <Card className="p-8 border-t-4 border-t-brand-pink hover:shadow-2xl transition-all">
              ...
              <p className="text-slate-600 mb-6 min-h-[80px]">
                Bulk purchasing for electronics, office furniture, and supplies.
                Get VAT invoices and dedicated account managers.
              </p>
              <ul className="space-y-3 mb-8">
                <li className="flex items-center gap-2 text-sm text-slate-700">
                  <CheckCircle size={16} className="text-green-500" /> Wholesale
                  Pricing
                </li>
                <li className="flex items-center gap-2 text-sm text-slate-700">
                  <CheckCircle size={16} className="text-green-500" /> Scheduled
                  Delivery
                </li>
                <li className="flex items-center gap-2 text-sm text-slate-700">
                  <CheckCircle size={16} className="text-green-500" /> Net-30
                  Payment Terms
                </li>
              </ul>
            ...
            <Card className="p-8 border-t-4 border-t-brand-yellow hover:shadow-2xl transition-all">
              ...
              <p className="text-slate-600 mb-6 min-h-[80px]">
                Upskill your workforce with private cohorts. English language,
                Coding, and Soft Skills training designed for companies.
              </p>
              <ul className="space-y-3 mb-8">
                <li className="flex items-center gap-2 text-sm text-slate-700">
                  <CheckCircle size={16} className="text-green-500" /> Progress
                  Dashboards
                </li>
                <li className="flex items-center gap-2 text-sm text-slate-700">
                  <CheckCircle size={16} className="text-green-500" /> Certified
                  Instructors
                </li>
                <li className="flex items-center gap-2 text-sm text-slate-700">
            ...
            <Card className="p-8 border-t-4 border-t-brand-dark hover:shadow-2xl transition-all">
              ...
              <p className="text-slate-600 mb-6 min-h-[80px]">
                Access the top 1% of Iraqi talent. Post jobs, manage applicants,
              ...
              <ul className="space-y-3 mb-8">
                ...
                <li className="flex items-center gap-2 text-sm text-slate-700">
                  <CheckCircle size={16} className="text-green-500" /> AI
                  Matching
                </li>
                <li className="flex items-center gap-2 text-sm text-slate-700">
      ...
      <section className="py-16 bg-white border-t border-slate-100">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <p className="text-sm font-bold text-slate-400 uppercase tracking-widest mb-8">
            Trusted by innovative companies in Iraq
          </p>
      ...
      <section className="bg-brand-yellow py-24 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-brand-dark/80 mb-8">
            Speak to a B2B specialist today and get a custom quote for your
            organization.
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Button variant="dark" className="h-14 px-8 text-lg">
              Contact Our Sales Team
            </Button>
            <Button
              variant="outline"
              className="h-14 px-8 text-lg bg-white border-white hover:bg-white/90"
            >
              View Pricing
            </Button>
          </div>
