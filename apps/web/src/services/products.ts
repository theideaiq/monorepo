...
export interface Product {
  ...
  isVerified: boolean;
  description: string;
  // biome-ignore lint/suspicious/noExplicitAny: Required for product details
...
function mapDBProductToUI(item: DBProduct): Product {
  ...
  return {
    ...
    // biome-ignore lint/suspicious/noExplicitAny: Required for product details mapping
