...
// biome-ignore lint/correctness/noUnusedImports: keep for future reference
...
async function getOrCreateCartId(
  // biome-ignore lint/suspicious/noExplicitAny: explicit any to avoid circular dependency or complex type
  supabase: any,
  userId: string,
): Promise<string | null> {
...
export async function fetchCartItems(): Promise<CartItem[]> {
  ...
  // biome-ignore lint/suspicious/noExplicitAny: casting for join result
