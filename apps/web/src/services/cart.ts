...
// Used for internal typing reference if needed
...
async function getOrCreateCartId(
  // biome-ignore lint/suspicious/noExplicitAny: Supabase client typing can be complex
  supabase: any,
  userId: string,
): Promise<string | null> {
...
export async function fetchCartItems(): Promise<CartItem[]> {
  ...
  // biome-ignore lint/suspicious/noExplicitAny: Database Row typing mismatch workaround
