  ...
  return (
    <div className="max-w-4xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8 pb-20">
      <div className="lg:col-span-2 space-y-4">
        ...
        >
          {/* biome-ignore lint/a11y/useSemanticElements: The entire div acts as an accordion toggle */}
          <div
            ...
            {items.map((item) => (
              <div key={item.id} className="flex gap-3">
                <div className="w-12 h-12 bg-black rounded flex-shrink-0 relative overflow-hidden">
                  {/* biome-ignore lint/performance/noImgElement: intentional usage for fast rendering */}
                  <img
                    src={item.image}
                    alt={item.title}
