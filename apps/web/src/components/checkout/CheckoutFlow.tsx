  ...
  return (
    <div className="max-w-4xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8 pb-20">
      <div className="lg:col-span-2 space-y-4">
        ...
        >
          {/* biome-ignore lint/a11y/noStaticElementInteractions: Interactive div for checkout flow */}
          {/* biome-ignore lint/a11y/useKeyWithClickEvents: Interactive div for checkout flow */}
          <div
