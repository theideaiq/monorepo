  ...
  return (
    <div className="max-w-4xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8 pb-20">
      <div className="lg:col-span-2 space-y-4">
        ...
        >
          {/* biome-ignore lint/a11y/useKeyWithClickEvents: flow stepper */}
          {/* biome-ignore lint/a11y/noStaticElementInteractions: flow stepper */}
          <div
                  ...
                  >
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="space-y-1">
                        {/* biome-ignore lint/a11y/noLabelWithoutControl: layout */}
