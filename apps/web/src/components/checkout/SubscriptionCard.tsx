...
export function SubscriptionCard({
  ...
  return (
    <button
      type="button"
      onClick={onSelect}
      className={`w-full text-left relative overflow-hidden rounded-2xl border-2 p-6 transition-all cursor-pointer
        ${
          isSelected
    ...
    >
      ...
      <div className="space-y-3">
        {plan.features.map((feature, idx) => (
          // biome-ignore lint/suspicious/noArrayIndexKey: simple array mapping
