...
export function SubscriptionCard({
  ...
  return (
    <button
      ...
      onClick={onSelect}
      className={`
        w-full text-left relative overflow-hidden rounded-2xl border-2 p-6 transition-all cursor-pointer focus:outline-none focus:ring-2 focus:ring-brand-yellow/50
        ${
          isSelected
