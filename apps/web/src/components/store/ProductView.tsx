...
// biome-ignore lint/correctness/noUnusedImports: Future features
import { CheckCircle2, Heart, Share2, ShoppingCart, Star } from 'lucide-react';
import Image from 'next/image';
import { useState } from 'react';
import { toast } from 'react-hot-toast';
import { VariantSelector } from '@/components/ui/VariantSelector';
// biome-ignore lint/correctness/noUnusedImports: Needed for props
...
export function ProductView({ product }: ProductViewProps) {
  ...
  // biome-ignore lint/correctness/noUnusedVariables: Future variant logic
