...
// Create formatter once outside component to avoid re-creation on every render
const priceFormatter = new Intl.NumberFormat('en-IQ');

// Memoized row component to prevent re-renders of all items when one changes
...
export function CartDrawer() {
  ...
  }, [items, updateQuantity, removeItem, closeCart]);
