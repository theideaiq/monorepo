  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-square bg-[#1a1a1a] overflow-hidden">
        ...
        {/* Quick Add Button (Visible on Hover / Focus / Mobile) */}
        <button
          type="button"
          onClick={(e) => {
            // Prevent event from bubbling up to the card click (if any)
            e.stopPropagation();
            onAddToCart?.(e);
          }}
          className="absolute bottom-3 right-3 z-20 p-3 bg-brand-yellow text-brand-dark rounded-full shadow-lg translate-y-12 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 focus-visible:translate-y-0 focus-visible:opacity-100 transition-all duration-300 hover:bg-white hover:text-black focus-visible:ring-2 focus-visible:ring-white"
        ...
        <div className="flex-1">
          <h3 className="text-white font-bold leading-tight mb-1 line-clamp-2 min-h-[2.5rem]">
            <Link
              ...
              className="before:absolute before:inset-0 focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-yellow rounded-2xl"
            >
