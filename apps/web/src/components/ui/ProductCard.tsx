      ...
      <div className="relative aspect-square bg-[#1a1a1a] overflow-hidden">
        {product.image ? (
          ...
          <div className="w-full h-full flex flex-col items-center justify-center bg-white/5 text-slate-500">
            ...
            <span className="text-[10px] uppercase tracking-widest font-medium opacity-50">
              No Image
            </span>
          </div>
        )}
        ...
        <button
          ...
          className="absolute bottom-3 right-3 p-3 bg-brand-yellow text-brand-dark rounded-full shadow-lg translate-y-12 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300 hover:bg-white hover:text-black z-20 relative"
