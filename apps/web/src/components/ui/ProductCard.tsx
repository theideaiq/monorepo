      ...
      >
        ...
        <div className="relative aspect-square bg-[#1a1a1a] overflow-hidden">
          ...
          <button
            ...
            className="absolute bottom-3 right-3 p-3 bg-brand-yellow text-brand-dark rounded-full shadow-lg opacity-100 translate-y-0 lg:opacity-0 lg:translate-y-12 lg:group-hover:opacity-100 lg:group-hover:translate-y-0 transition-all duration-300 hover:bg-white hover:text-black z-10"
