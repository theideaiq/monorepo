      ...
      >
        ...
        <div className="relative aspect-square bg-[#1a1a1a] overflow-hidden">
          ...
          <button
            ...
            className="absolute bottom-3 right-3 p-3 bg-brand-yellow text-brand-dark rounded-full shadow-lg translate-y-12 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 focus-visible:translate-y-0 focus-visible:opacity-100 focus-visible:ring-2 focus-visible:ring-brand-yellow focus-visible:ring-offset-2 focus-visible:ring-offset-[#1a1a1a] transition-all duration-300 hover:bg-white hover:text-black z-10"
