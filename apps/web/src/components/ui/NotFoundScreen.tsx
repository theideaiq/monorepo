  ...
  return (
    <div className="flex min-h-screen w-full flex-col items-center justify-center bg-neutral-950 p-4 text-center select-none">
      <div className="mb-8 relative">
        ...
        <Compass className="relative w-24 h-24 text-yellow-400 animate-pulse" />
      </div>
      ...
      <Link
        href="/"
        className="px-8 py-3 rounded-full font-bold bg-yellow-400 text-neutral-950 hover:bg-yellow-300 transition-colors transform hover:scale-105 active:scale-95"
      >
        Return to Command
      </Link>
    </div>
