      ...
      <section className="relative pt-32 pb-20 px-6 max-w-7xl mx-auto flex flex-col items-center text-center z-10">
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full justify-center">
          <a
            ...
            target="_blank"
            className="group relative px-8 py-4 bg-brand-yellow text-black font-bold rounded-xl text-lg flex items-center justify-center gap-2 hover:bg-yellow-400 transition-all hover:scale-105"
            rel="noopener"
          >
